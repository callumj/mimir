...
func TestSeriesChunkRef_Compare(t *testing.T) {
	input := []seriesChunkRefsGroup{
		{blockID: ulid.MustNew(0, nil), chunks: []seriesChunkRef{{minTime: 2, maxTime: 5}}},
		{blockID: ulid.MustNew(1, nil), chunks: []seriesChunkRef{{minTime: 1, maxTime: 5}}},
		{blockID: ulid.MustNew(2, nil), chunks: []seriesChunkRef{{minTime: 1, maxTime: 3}}},
		{blockID: ulid.MustNew(3, nil), chunks: []seriesChunkRef{{minTime: 4, maxTime: 7}}},
		{blockID: ulid.MustNew(4, nil), chunks: []seriesChunkRef{{minTime: 3, maxTime: 6}}},
	}

	expected := []seriesChunkRefsGroup{
		{blockID: ulid.MustNew(2, nil), chunks: []seriesChunkRef{{minTime: 1, maxTime: 3}}},
		{blockID: ulid.MustNew(1, nil), chunks: []seriesChunkRef{{minTime: 1, maxTime: 5}}},
		{blockID: ulid.MustNew(0, nil), chunks: []seriesChunkRef{{minTime: 2, maxTime: 5}}},
		{blockID: ulid.MustNew(4, nil), chunks: []seriesChunkRef{{minTime: 3, maxTime: 6}}},
...
func TestSeriesChunkRefsIterator(t *testing.T) {
	...
	t.Run("should iterate a set with some items", func(t *testing.T) {
		it := newSeriesChunkRefsIterator(seriesChunkRefsSet{
			series: []seriesChunkRefs{
				{lset: series1, groups: []seriesChunkRefsGroup{c[0], c[1]}},
				{lset: series2, groups: []seriesChunkRefsGroup{c[2]}},
				{lset: series3, groups: []seriesChunkRefsGroup{c[3], c[4]}},
			},
		})
		...
		require.Equal(t, seriesChunkRefs{lset: series1, groups: []seriesChunkRefsGroup{c[0], c[1]}}, it.At())
		require.False(t, it.Done())

		require.True(t, it.Next())
		require.Equal(t, seriesChunkRefs{lset: series2, groups: []seriesChunkRefsGroup{c[2]}}, it.At())
		require.False(t, it.Done())

		require.True(t, it.Next())
		require.Equal(t, seriesChunkRefs{lset: series3, groups: []seriesChunkRefsGroup{c[3], c[4]}}, it.At())
		require.False(t, it.Done())
	...
	t.Run("should re-initialize the internal state on reset()", func(t *testing.T) {
		...
		it.reset(seriesChunkRefsSet{
			series: []seriesChunkRefs{
				{lset: series1, groups: []seriesChunkRefsGroup{c[3]}},
				{lset: series4, groups: []seriesChunkRefsGroup{c[4]}},
			},
		})
		...
		require.True(t, it.Next())
		require.Equal(t, seriesChunkRefs{lset: series1, groups: []seriesChunkRefsGroup{c[3]}}, it.At())
		require.False(t, it.Done())

		require.True(t, it.Next())
		require.Equal(t, seriesChunkRefs{lset: series4, groups: []seriesChunkRefsGroup{c[4]}}, it.At())
		require.False(t, it.Done())
	...
	testCases := map[string]struct {
		...
		"should iterate a set with multiple items": {
			input: newSliceSeriesChunkRefsSetIterator(nil,
				seriesChunkRefsSet{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}},
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[2]}},
				}}),
			expected: []seriesChunkRefs{
				{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}},
				{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[2]}},
		...
		"should iterate multiple sets with multiple items each": {
			input: newSliceSeriesChunkRefsSetIterator(nil,
				...
				seriesChunkRefsSet{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{c[3]}},
				}},
				seriesChunkRefsSet{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v4"), groups: []seriesChunkRefsGroup{c[4]}},
					{lset: labels.FromStrings("l1", "v5"), groups: []seriesChunkRefsGroup{c[5]}},
				}}),
			expected: []seriesChunkRefs{
				{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}},
				{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[2]}},
	...
	testCases := map[string]struct {
		...
		"merges two sets without overlap": {
			...
			set1: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[0]}},
				},
			}),
			set2: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[1], c[2], c[3]}},
				},
			}),
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
		...
		"merges two sets with last series from each overlapping": {
			...
			set1: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[0]}},
				},
			}),
			set2: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}},
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[0], c[2], c[3]}},
				},
			}),
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}},
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[0], c[0], c[2], c[3]}},
				}},
			},
		},
		"merges two sets where the first is empty": {
			...
			set2: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[0]}},
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[1]}},
				},
			}),
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
		...
		"merges two sets with shorter one erroring at the end": {
			...
			set1: newSliceSeriesChunkRefsSetIterator(errors.New("something went wrong"), seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: make([]seriesChunkRefsGroup, 1)},
					{lset: labels.FromStrings("l1", "v2"), groups: make([]seriesChunkRefsGroup, 1)},
				},
			}),
			set2: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v2"), groups: make([]seriesChunkRefsGroup, 1)},
					{lset: labels.FromStrings("l1", "v3"), groups: make([]seriesChunkRefsGroup, 1)},
					{lset: labels.FromStrings("l1", "v4"), groups: make([]seriesChunkRefsGroup, 1)},
				},
			}),
			expectedSets: nil, // We expect no returned sets because an error occurred while creating the first one.
			expectedErr:  "something went wrong",
		...
		"should stop iterating as soon as the first underlying set returns an error": {
			...
			set1: newSliceSeriesChunkRefsSetIterator(errors.New("something went wrong"), seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[0]}},
					{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{c[2]}},
				},
			}),
			set2: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[1]}},
					{lset: labels.FromStrings("l1", "v4"), groups: []seriesChunkRefsGroup{c[3]}},
				},
			}),
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
		...
		"should return merged groups sorted by min time (assuming source sets have sorted groups) on first chunk on first set": {
			...
			set1: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1], c[3]}},
				},
			}),
			set2: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[0], c[2]}},
				},
			}),
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[0], c[1], c[2], c[3]}},
				}},
			},
		},
		"should return merged groups sorted by min time (assuming source sets have sorted groups) on first chunk on second set": {
			...
			set1: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[0], c[3]}},
				},
			}),
			set2: newSliceSeriesChunkRefsSetIterator(nil, seriesChunkRefsSet{
				series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1], c[2]}},
				},
			}),
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
		...
		"should keep iterating on empty underlying sets (batch size = 1)": {
			...
			set1: newSliceSeriesChunkRefsSetIterator(nil,
				seriesChunkRefsSet{},
				seriesChunkRefsSet{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}}}},
				seriesChunkRefsSet{},
				seriesChunkRefsSet{},
				seriesChunkRefsSet{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{c[3]}}}},
				seriesChunkRefsSet{},
				seriesChunkRefsSet{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v5"), groups: []seriesChunkRefsGroup{c[5]}}}},
				seriesChunkRefsSet{},
			),
			set2: newSliceSeriesChunkRefsSetIterator(nil,
				seriesChunkRefsSet{},
				seriesChunkRefsSet{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[2]}}}},
				seriesChunkRefsSet{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{c[3]}}}},
				seriesChunkRefsSet{},
				seriesChunkRefsSet{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v4"), groups: []seriesChunkRefsGroup{c[4]}}}},
			),
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[2]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{c[3], c[3]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v4"), groups: []seriesChunkRefsGroup{c[4]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v5"), groups: []seriesChunkRefsGroup{c[5]}}}},
			},
		},
		"should keep iterating on empty underlying sets (batch size = 2)": {
			...
			expectedSets: []seriesChunkRefsSet{
				...
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{c[3], c[3]}},
					{lset: labels.FromStrings("l1", "v4"), groups: []seriesChunkRefsGroup{c[4]}},
				}},
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v5"), groups: []seriesChunkRefsGroup{c[5]}},
		...
		"should keep iterating on second set after first set is exhausted (batch size = 1)": {
			...
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{c[1]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{c[2]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{c[3]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v4"), groups: []seriesChunkRefsGroup{c[4]}}}},
				{series: []seriesChunkRefs{{lset: labels.FromStrings("l1", "v5"), groups: []seriesChunkRefsGroup{c[5]}}}},
			},
		},
...
func TestDeduplicatingSeriesChunkRefsSetIterator(t *testing.T) {
	...
	sourceSets := []seriesChunkRefsSet{
		{series: []seriesChunkRefs{
			{lset: series1, groups: []seriesChunkRefsGroup{c[0], c[1]}},
			{lset: series1, groups: []seriesChunkRefsGroup{c[2], c[3], c[4]}},
		}},
		{series: []seriesChunkRefs{
			{lset: series2, groups: []seriesChunkRefsGroup{c[0], c[1], c[2], c[3]}},
			{lset: series3, groups: []seriesChunkRefsGroup{c[0]}},
			{lset: series3, groups: []seriesChunkRefsGroup{c[1]}},
		}},
	}
	...
	t.Run("batch size: 1", func(t *testing.T) {
		...
		assert.Equal(t, []seriesChunkRefsGroup{c[0], c[1], c[2], c[3], c[4]}, sets[0].series[0].groups)

		require.Len(t, sets[1].series, 1)
		assert.Equal(t, series2, sets[1].series[0].lset)
		assert.Equal(t, []seriesChunkRefsGroup{c[0], c[1], c[2], c[3]}, sets[1].series[0].groups)

		require.Len(t, sets[2].series, 1)
		assert.Equal(t, series3, sets[2].series[0].lset)
		assert.Equal(t, []seriesChunkRefsGroup{c[0], c[1]}, sets[2].series[0].groups)
	})
	...
	t.Run("batch size: 2", func(t *testing.T) {
		...
		assert.Equal(t, []seriesChunkRefsGroup{c[0], c[1], c[2], c[3]}, sets[0].series[1].groups)

		// Second batch.
		require.Len(t, sets[1].series, 1)

		assert.Equal(t, series3, sets[1].series[0].lset)
		assert.Equal(t, []seriesChunkRefsGroup{c[0], c[1]}, sets[1].series[0].groups)
	})
	...
	t.Run("batch size: 3", func(t *testing.T) {
		...
		assert.Equal(t, []seriesChunkRefsGroup{c[0], c[1]}, sets[0].series[2].groups)
	})
}
	...
	testCases := map[string]struct {
		...
		"doesn't exceed limits": {
			...
			sets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: make([]seriesChunkRefsGroup, 1)},
					{lset: labels.FromStrings("l1", "v2"), groups: make([]seriesChunkRefsGroup, 1)},
					{lset: labels.FromStrings("l2", "v1"), groups: make([]seriesChunkRefsGroup, 1)},
					{lset: labels.FromStrings("l2", "v2"), groups: make([]seriesChunkRefsGroup, 1)},
				}},
			},
		},
		"exceeds groups limit": {
			...
			sets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: make([]seriesChunkRefsGroup, 1)},
					{lset: labels.FromStrings("l1", "v2"), groups: make([]seriesChunkRefsGroup, 2)},
					{lset: labels.FromStrings("l2", "v1"), groups: make([]seriesChunkRefsGroup, 3)},
					{lset: labels.FromStrings("l2", "v2"), groups: make([]seriesChunkRefsGroup, 4)},
				}},
			},
		},
...
func TestLoadingSeriesChunkRefsSetIterator(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"loads one batch": {
			...
			expectedSets: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("l1", "v1"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{minTime: 10, maxTime: 10, ref: 26}}}}},
					{lset: labels.FromStrings("l1", "v2"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{minTime: 20, maxTime: 20, ref: 234}}}}},
					{lset: labels.FromStrings("l1", "v3"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{minTime: 30, maxTime: 30, ref: 442}}}}},
					{lset: labels.FromStrings("l1", "v4"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{minTime: 40, maxTime: 40, ref: 650}}}}},
				}},
			},
		},
	...
	for i, actualSet := range actual {
		...
		for j, actualSeries := range actualSet.series {
			...
			for k, actualGroup := range actualSeries.groups {
				...
				require.Lenf(t, actualGroup.chunks, len(expectedGroup.chunks), "chunks len [%d, %d, %d]", i, j, k)
				for l, actualChunk := range actualGroup.chunks {
					expectedChunk := expectedGroup.chunks[l]
					assert.Equalf(t, int(expectedChunk.ref), int(actualChunk.ref), "ref [%d, %d, %d, %d]", i, j, k, l)
...
func TestOpenBlockSeriesChunkRefsSetsIterator(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"selects all series in a single batch": {
			...
			expectedSeries: []seriesChunkRefsSet{
				{series: []seriesChunkRefs{
					{lset: labels.FromStrings("a", "1", "b", "1"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{ref: 8, minTime: 0, maxTime: 124}, {ref: 57, minTime: 125, maxTime: 199}}}}},
					{lset: labels.FromStrings("a", "1", "b", "2"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{ref: 95, minTime: 0, maxTime: 124}, {ref: 144, minTime: 125, maxTime: 199}}}}},
					{lset: labels.FromStrings("a", "2", "b", "1"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{ref: 182, minTime: 200, maxTime: 332}, {ref: 234, minTime: 333, maxTime: 399}}}}},
					{lset: labels.FromStrings("a", "2", "b", "2"), groups: []seriesChunkRefsGroup{{chunks: []seriesChunkRef{{ref: 270, minTime: 200, maxTime: 332}, {ref: 322, minTime: 333, maxTime: 399}}}}},
				}},
			},
		},
...
func generateSeriesChunkRef(blockID ulid.ULID, numChunks int) []seriesChunkRefsGroup {
	groups := make([]seriesChunkRefsGroup, 0, numChunks)

	for i := 0; i < numChunks; i++ {
		groups = append(groups, seriesChunkRefsGroup{
			blockID: blockID,
			chunks: []seriesChunkRef{
				{
					ref:     chunks.ChunkRef(10 * i),
					minTime: int64(i),
					maxTime: int64(i),
					length:  10,
				},
