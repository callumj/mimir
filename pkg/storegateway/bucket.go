...
func (noopCache) FetchMultiChunks(ctx context.Context, userID string, ranges []chunkscache.Range, bytesPool *pool.SafeSlabPool[byte]) (hits map[chunkscache.Range][]byte, misses []chunkscache.Range) {
	return nil, ranges
}
