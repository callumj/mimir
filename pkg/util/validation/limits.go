...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.IgnoreNativeHistogramsOnRead, "store-gateway.ignore-native-histograms-on-read", false, "True to stop processing native histograms as soon as possible.")
